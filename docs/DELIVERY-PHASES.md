...
The hosted Phase 10 failure also exposed OpenSSL version drift in the acceptance script because the runner did not recognize `req -noenc`.
The script now uses the compatible `req -nodes` form, and local Phase 10 acceptance passes 55 of 55 checks.
