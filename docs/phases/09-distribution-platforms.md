...
- [ ] Distribution claims are backed by signing/notarization evidence or explicitly identify unsigned local status.
- [ ] Accessibility, performance and print targets pass for each advertised platform.
- [ ] No placeholder capability, stale test count or skipped quality scan is presented as completed acceptance.
